...
export const platformMeta: Record<string, PlatformMeta> = {
  ...
  slack: {
    ...
    fields: [
      ...
      { key: 'allow_from', labelKey: 'fields.allowFrom', placeholder: '* (all)', group: 'advanced' },
      { key: 'session_scope', labelKey: 'fields.sessionScope', placeholder: 'user', group: 'advanced', hintKey: 'fields.sessionScopeHint' },
      { key: 'share_session_in_channel', labelKey: 'fields.sharedChannelSession', type: 'boolean', group: 'advanced' },
    ],
  },
  dingtalk: {
    ...
    fields: [
      ...
      { key: 'allow_from', labelKey: 'fields.allowFrom', placeholder: '* (all)', group: 'advanced' },
      { key: 'share_session_in_channel', labelKey: 'fields.sharedGroupSession', type: 'boolean', group: 'advanced' },
      { key: 'reaction_emoji', labelKey: 'fields.reactionEmoji', placeholder: '🤔Thinking', group: 'advanced', hintKey: 'fields.reactionEmojiHint' },
      { key: 'done_emoji', labelKey: 'fields.doneEmoji', placeholder: 'none', group: 'advanced', hintKey: 'fields.doneEmojiHint' },
